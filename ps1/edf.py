...
'''
Class Name: Sigmoid
Class Usage: compute the sigmoid activation. Input is vector [x_{0}, x_{1}, ..., x_{n}], output is vector [y_{0}, y_{1}, ..., y_{n}] where y_{i} = 1/(1 + exp(-x_{i}))
Class Functions:
...
'''
Class Name: SoftMax
Class Usage: compute the softmax activation. Input is vector [x_{0}, x_{1}, ..., x_{n}], output is vector [p_{0}, p_{1}, ..., p_{n}] where p_{i} = exp(x_{i})/(exp(x_{0}) + ... + exp(x_{n}))
Class Functions:
